...
public class KritOb implements Calculator {
	@Override
	public void showWindow(Stage PrimaryStage, Label lbl) {
		...
		stg.setScene(scn);
		stg.setTitle("Критический обьем производства и реализации продукции");
	...
	public void calculateAndSetLabel(Label lbl, String f, String p, String v) {
		try {
			...
			lbl.setText("Критический обьем производства и реализации продукции: " + s);
